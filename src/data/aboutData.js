export const aboutData = {
  ...
  description2: (
    <>
      ...
      <strong>state management</strong> to crafting smooth{" "}
      <strong>UI/UX experiences</strong>, I enjoy bridging the gap between
      product ideas and robust technical execution. I believe great software is
      built not just by writing code, but by understanding users, asking the
      right questions, and constantly figuring things out.
    </>
  ),
  image: 2,
};
